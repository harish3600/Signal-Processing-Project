...
for SN=0:3:81 %Varying SNR
  ...
  for int=0:T %Running trials (1000 times) by varying phase for signals 
    ...
    r = 1*(exp(1i*w*n)); %Adding phase to get different signals for each trial
    rn = r + nzv; %r[n] = Ae + w[n]
